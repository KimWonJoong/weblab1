...
<!-- Ex. 1: File of Courses -->
    ...
    ?>
    <p> 
        Course list <?= $count ?> has total courses
        and
        size of <?= $size ?> bytes.
    </p>
</div>
...
<!-- Ex. 2: Today’s Courses & Ex 6: Query Parameters -->
        <?php
            function getCoursesByNumber($listOfCourses, $numberOfCourses="3"){
                $resultArray = array();
//                implement here.
        ...
        <ol>
            <?php 
                $todaysCourses = array();
                $todaysCourses = getCoursesByNumber($lines, $_GET["numberOfCourses"]);
...
<!-- Ex. 3: Searching Courses & Ex 6: Query Parameters -->
        <?php
            function getCoursesByCharacter($listOfCourses, $startCharacter="C"){
                $resultArray = array();
//              
                return $resultArray;
            }
...
<!-- Ex. 4: List of Courses & Ex 6: Query Parameters -->
        <?php
            function getCoursesByOrder($listOfCourses, $orderby="0"){
